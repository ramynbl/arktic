...
export function AIChatBox({
  ...
  const recalculateMinHeight = useCallback(() => {
  ...
  useEffect(() => {
    ...
    window.addEventListener("resize", recalculateMinHeight);
    return () => window.removeEventListener("resize", recalculateMinHeight);
  }, [recalculateMinHeight]);

  // Scroll to bottom with double rAF to ensure DOM has painted
